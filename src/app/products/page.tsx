    ...
    <div className="min-h-screen bg-slate-50 font-sans pt-28">
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 pb-12">
        ...
        <div className="mb-8 flex flex-col gap-4">
          {/* relative z-40: the glass cards each create a backdrop-filter stacking
              context, so lift this row above the category card below it — otherwise
              the Sort dropdown menu renders behind that card. */}
