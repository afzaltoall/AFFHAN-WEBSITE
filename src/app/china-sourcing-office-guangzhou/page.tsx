  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "China Sourcing Office in Guangzhou", item: "https://affhan.com/china-sourcing-office-guangzhou/" },
      ],
    },
  ],
};
...
export default async function ChinaSourcingOfficeGuangzhouPage() {
  ...
  return (
    <main className="w-full bg-slate-50 min-h-screen pb-0">
      ...
      <OtherLocations current="china-sourcing-office-guangzhou" />
