 ...
 * then re-encoded. 176x176 at 16KB. It has a real alpha channel, so it needs
 * no plate behind it and works on any surface.
 *
 * Landscape now, where the old sailboat silhouette was portrait (166x175):
 * the replacement mark does not trim at all — 1254x1254 in, 1254x1254 out. Both call sites size on one axis
