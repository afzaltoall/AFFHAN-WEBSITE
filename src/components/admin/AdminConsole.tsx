          ...
          {view === "overview" ? (
            ...
            <div className={`overflow-hidden rounded-2xl shadow-sm ring-1 ${t.card}`}>
              <div className={`flex flex-col gap-3 border-b p-4 sm:flex-row sm:items-center ${t.border}`}>
                ...
                {view !== "trash" && (
                  <button onClick={exportExcel} title={selected.size > 0 ? `Export ${selected.size} selected` : "Export all"} className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#1d1d1f] px-4 py-2.5 text-[13px] font-semibold text-white transition-colors hover:bg-black">
